...
import Lib1 from "./libs/lib1";
import Lib2 from "./libs/lib2";
...
export class DependentLibrary implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    /**
     * Empty constructor.
     */
    constructor() {
...
(function () {
    window.lib1 = Lib1;
    window.lib2 = Lib2;
    window.clientLibraries = clientLibraries;
})();